...
function openBook() {
  ...
  prevBtn.style.transform = "translateX(-14rem)";
  prevBtn.style.transition = "all .3s .05s";
  nextBtn.style.transform = "translateX(14rem)";
  nextBtn.style.transition = "all .3s .05s";
}
...
function closeBook(isAtBeginning) {
  ...
  prevBtn.style.transition = "all .3s .1s";
  prevBtn.style.transform = "translateX(0)";
  nextBtn.style.transform = "translateX(0)";
  nextBtn.style.transition = "all .3s .1s";
}
